...
public class RemovingItemFromShopingCartTest {
    private WebDriver driver;
    private String baseUrl;
    
    public RemovingItemFromShopingCartTest() {
    }
    ...
    @Test
    public void testRemovingItemFromShoppingCart() throws InterruptedException{
        driver.get(baseUrl);
